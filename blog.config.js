...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'eggNoman', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '和处女座毫无关系的intj。目前与地下丝绒热恋中', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-lime-iota.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Love, Life', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'Eurus4147@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || '一间空屋子', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【xxxxxx】==#wechat_redirect
